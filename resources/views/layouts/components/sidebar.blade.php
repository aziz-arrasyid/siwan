    ...
    <div class="data-scrollbar" data-scroll="1">
      <nav class="iq-sidebar-menu">
        <ul id="iq-sidebar-toggle" class="iq-menu">
          ...
          <li class="{{ Route::is('waktuabsensi.index') ? 'active' : '' }}">
            <a href="{{ route('waktuabsensi.index') }}" class="svg-icon">
              <svg class="svg-icon" width="25" height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path>
                <rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect>
              </svg>
        ...
        <ul id="iq-sidebar-toggle" class="iq-menu">
          ...
          <li class="">
              ...
              <ul id="DataMaster" class="iq-submenu collapse">
                ...
                <li class="{{ route::is('waktuAbsensiKelas.get') ? 'active' : '' }}">
                  <a href="{{ route('waktuAbsensiKelas.get') }}">
                    <i class="las la-minus"></i><span class="">Rekap Absensi</span>
                  </a>
                </li>
              </ul>
          </li>
